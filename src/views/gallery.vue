<template>
    <div class="head">
        <div class="submain" id="subnavbar" style="margin-top: 0vw;">
            ...
            <div class="sub">
                ...
                <button class="b1" @click="route('/gallery')"   style="background-color: #7BA05B;;border-width:0.3vw">
                    GALLERY
                </button>
    ...
    <div class="body">
        <div class="d1" v-if="user == null">
            <p class="t0">all the snapshots<br><span style="color: #243208;">from battle of bytes</span></p>
            <p class="t3">click on the photos to open large preview...</p>
        </div>
        <div class="d2">
            <img @click="selectedimg= imgs.indexOf(item),lprev=true" :key="item" v-for="item in imgs" :src="require(`../assets/imgs/${item}.jpg`)">
        </div>
        <div class="d3" v-if="lprev">
            <div class="buttons">
                <button @click="selectedimg=Math.max(selectedimg-1,0)">PREV</button>
                <button @click="selectedimg=Math.min(selectedimg+1,imgs.length)">NEXT</button>
                <button @click="lprev=false" style="padding:0;width: 2vw;height:auto;background-color:transparent;"><span 
                    style="font-size: 2.2vw;color:white;" class="material-icons">cancel</span></button>
            </div>
            <img :key="item" :src="require(`../assets/imgs/${imgs[selectedimg]}.jpg`)">
        </div>
    </div>
    <div class="foot">
    </div>
