<template>
    ...
    <div class="body">
        <div class="d1" v-if="user == null">
            <p class="t0">meet the members of<br><span style="color: #2B1008;">JavaScript Titans...</span></p>
        </div>
        <div class="d2">
            <div class="sub">
                <p class="title">Tanishq Singh Rajawat</p>
            </div>
            <div class="sub">
                <p class="title">Aditya Arya</p>
            </div>
            <div class="sub">
                <p class="title">Khush Khandelwal</p>
            </div>
            <div class="sub">
                <p class="title">Radheyshree Agarwal</p>
            </div>
            <div class="sub">
                <p class="title">Pravallika Sekharamantri</p>
            </div>
            <div class="sub">
                <p class="title">Gourav Mittal</p>
            </div>
            <div class="sub">
                <p class="title">Tejas Mittal</p>
            </div>
            <div class="sub">
                <p class="title">Harshal Verma</p>
            </div>
            <div class="sub">
                <p class="title">Himank Jain</p>
            </div>
            <div class="sub">
                <p class="title">Arpit Benjamin</p>
            </div>
            <div class="sub">
                <p class="title">Jyotirmya Sharma</p>
            </div>
        </div>
    </div>
    <div class="foot">
...
export default {
    ...
    mounted() {
        document.body.style.backgroundColor = '#aa3d0e';
    },
    beforeDestroy() {
